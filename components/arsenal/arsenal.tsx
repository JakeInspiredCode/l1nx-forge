...
const ACTIVITIES: Activity[] = [
  ...
  { id: "downtime-smash", title: "Downtime Smash", description: "Solve simulated datacenter tickets at 6 difficulty levels", icon: "🎫", category: "practice", blooms: "Apply", difficulty: "Mixed", topics: ["linux", "hardware", "networking"], estimatedMinutes: 15, route: "/battle-station" },
  // TEST
