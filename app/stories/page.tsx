...
const DEFAULT_STORIES = [
  { storyId: "story-1", question: "Why this company?", framework: "Mission + Scale + Background Fit",
    answer: "The mission of pushing AI infrastructure to its limits resonates deeply with me. A 100K+ GPU cluster operating as a single system represents the most ambitious infrastructure build in AI. My background combines military discipline and rapid deployment experience with hands-on data center operations. I thrive in high-stakes environments where speed and precision both matter. A culture of moving fast and building big is exactly where I want to be." },
