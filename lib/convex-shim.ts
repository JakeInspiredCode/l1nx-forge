...
function getDemoDefault(fnRef: unknown, args: any): unknown {
  ...
  const singles: Record<string, unknown> = {
    ...
    "forgeTicketHistory:getAll": [],
    "forgeTicketHistory:getBestByTicket": null,
    "forgeTicketHistory:getByTicket": [],
    "forgeTicketHistory:getByDifficulty": [],
    "forgeTicketHistory:getRecent": [],
